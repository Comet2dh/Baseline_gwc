...
parser.add_argument('--logdir', default='./checkpoints/test', help='the directory to save logs and checkpoints')
    ...
    for epoch_idx in range(start_epoch, args.epochs):
        ...
        for batch_idx, sample in enumerate(TestImgLoader):
            ...
            if do_summary:
                ...
                if scalar_outputs["D1"][0]>0.12:
                    #save_scalars(logger, 'error match', scalar_outputs, global_step)
                    save_images(logger, 'error match', image_outputs, global_step)
